          ...
          <div class="card-header">
            <div class="row">
              <div class="col-md-12">
                <div>
                  <center>
                    <h2 style="font-family: sans-serif;"><b>Klasifikasi Kelayakan Penerima PKH</b></h2>
                  </center>
              ...
              <div class="col-md-12">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    ...
                    <body>
                      <br>
                      <h4 style="font-family: sans-serif;"><b>Grafik Status Kelayakan Penerima PKH</b></h4>
                        ...
                        var chart = new Chart(ctx, {
                          ...
                          data: {
                            ...
                            datasets: [{
                              ...
                              backgroundColor: ['rgb(34, 139, 34)', 'rgb(220, 20, 60)', 'rgb(175, 238, 239)'],
