        ...
        <div class="row g-0">
          ...
          <div class="col-md-7">
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-sm-5">
                  <a class="btn btn-secondary" href="<?= base_url('DataChart/editprofile'); ?>">Edit Profile</a>
                </div>
                <div class="col-sm-7">
                  <a class="btn btn-secondary" href="<?= base_url('DataChart/changepassword'); ?>">Change Password</a>
                </div>
              </div>
